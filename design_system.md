...
- **Ledger Month Filter**: The Finance Ledger page should default to a monthly data window. Place the month selector beside CSV export actions, and make cards, activity charts, table rows, pagination, and CSV export reflect the selected month.
