...
- **Dashboard/App Tables**: Transaction tables default to 15 rows per page. Sortable headers use compact text buttons with asc/desc indicators and no layout shift.
