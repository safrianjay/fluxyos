...
| 14 | Ledger date filter appears beside Download CSV, defaults to the current month, opens a custom range calendar without Day/Month tabs, supports single-day and range selection, disables future dates, and updates ledger cards, activity charts, table rows, pagination, and CSV export scope |
