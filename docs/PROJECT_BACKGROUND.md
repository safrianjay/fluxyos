...
>    `pos_outlet_settings`, `pos_discount_presets`,
...
| [`data-model/pos.md`](data-model/pos.md) | `pos_tables`, `pos_orders`, `pos_shifts`, `pos_reservations`, `pos_table_directory`, `pos_outlet_settings`, `pos_discount_presets` |
